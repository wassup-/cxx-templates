...
namespace tmpl {
	namespace detail {
		...
		struct num_arguments_min : std::integral_constant<std::size_t, sizeof...(T)> { };

		template<template<typename...> class C, typename... T>
		struct num_arguments_min<false, C, T...> : num_arguments_min<is_valid_specialization<C, T..., char>::value, C, T..., char> { };
	...
	struct template_traits {
		constexpr static std::size_t min_args = detail::num_arguments_min<is_valid_specialization<C>::value, C>::value;
		constexpr static std::size_t max_args = detail::num_arguments_max<is_valid_specialization<C>::value ? detail::specialization_state::valid : detail::specialization_state::invalid, C>::value;
